...
class LinearSoftmaxClassifier():
    ...
    def fit(self, X, y, batch_size=100, learning_rate=1e-7, reg=1e-5,
        ...
        for epoch in range(epochs):
            ...
            current_batch = np.random.randint(len(batches_indices))
            current_x = X[batches_indices[current_batch]]
            current_y = y[batches_indices[current_batch]]
            loss, dW = linear_softmax(current_x, self.W, current_y)
